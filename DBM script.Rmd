...
palette= "npg",
size=1.2,
font.legend=list(face="italic",size=16),
fontsize=8,
censor.shape=""
###Darjeeling 2
)+
...
Figure2$table <- Figure2$table +theme(axis.text.y = element_text(hjust=0,margin = margin(b = 0.5),face="italic", size="16"))
...
geom_sina(stat="sina", position="dodge", kernel="gaussian", method="density", size=2, aes())+theme(legend.position = "none")+
  ...
  annotate("text", size=5, label = "a", x = 1, y = 2.5)+
  annotate("text", size=5, label = "ab", x = 2, y = 2.5)+
  annotate("text", size=5, label = "ab", x = 3, y = 2.5)+
  annotate("text", size=5, label = "bc", x = 4, y = 2.5)+
  theme_cowplot()
